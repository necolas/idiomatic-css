...
* [Идиомы CSS на английском языке (Original)](https://github.com/necolas/idiomatic-css)
...
Используйте поняные и осмысленные имена для классов в HTML. Выберите ясный и
...
Хороший интсрумент для этих задач —
