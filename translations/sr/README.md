...
5. [Imenovanje](#naming)
6. [Praktični primeri](#practical-example)
...
piši tvj kod sa maksimalnom jasnoćom, a ne sa svojim personalnim preferencijama
o tome kako da se napraviš pametan u okviru specifikacije." - Idan Gazit
...
* Koristite jedan ili dupli apostrof konzistentno. Preferencija je da se koriste
dupli apostrofi, npr `content: ""`.
...
vaše funkcije sa nativnim CSS funkcijama, ili da dođe do "sukoba" sa funkcijama
iz drugih biblioteka.
...
[idiomatic.js](https://github.com/rwldrn/idiomatic.js) projektu. Taj projekat je
bio izvor inspiracije, citata i smernica.
